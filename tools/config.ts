...
export const APP_TITLE            = 'Did or Wish';
...
export const FONTS_DEST           = `${APP_DEST}/css/themes/default/assets/fonts`;
...
export const APP_ASSETS = [
  ...
  { src: 'semantic/dist/semantic.min.css', dest: CSS_DEST, inject: true },

  { src: 'semantic/dist/themes/default/assets/fonts/icons.eot',   dest: FONTS_DEST},
  { src: 'semantic/dist/themes/default/assets/fonts/icons.svg',   dest: FONTS_DEST},
  { src: 'semantic/dist/themes/default/assets/fonts/icons.ttf',   dest: FONTS_DEST},
  { src: 'semantic/dist/themes/default/assets/fonts/icons.woff',  dest: FONTS_DEST},
  { src: 'semantic/dist/themes/default/assets/fonts/icons.woff2', dest: FONTS_DEST}
];
